...
import java.util.*;
    ...
    /** A DiagramSelectionEvent is triggered when the user indicates that their
        crop selection is final. */
public class DiagramSelectionEvent extends EventObject {
    ...
    */
    ...
    public DiagramSelectionEvent(DiagramDialog source) {
        super(source);
        diagramType = source.getSelectedDiagram();
    }
